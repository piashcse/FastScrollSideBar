...
public class WaveSideBarView extends View {
	...
	private void initAttribute(AttributeSet attrs, int defStyleAttr) {
		TypedArray typeArray = getContext().obtainStyledAttributes(attrs, R.styleable.WaveSideBarView, defStyleAttr, 0);
		mBackgroundColor = typeArray.getColor(R.styleable.WaveSideBarView_backgroundColor, Color.parseColor("#F9F9F9"));
		mStrokeColor = typeArray.getColor(R.styleable.WaveSideBarView_strokeColor, Color.parseColor("#000000"));
		mTextColor = typeArray.getColor(R.styleable.WaveSideBarView_textColor, Color.parseColor("#969696"));
		mTextSize = typeArray.getDimensionPixelOffset(R.styleable.WaveSideBarView_textSize,
													  (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 10,
																					  getResources().getDisplayMetrics()));
		mSelectTextColor = typeArray.getColor(R.styleable.WaveSideBarView_selectTextColor, Color.parseColor("#FFFFFF"));
		mSelectTextSize = typeArray.getDimensionPixelOffset(R.styleable.WaveSideBarView_selectTextSize,
															(int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 10,
																							getResources().getDisplayMetrics()));
		mHintTextColor = typeArray.getColor(R.styleable.WaveSideBarView_hintTextColor, Color.parseColor("#FFFFFF"));
		mHintTextSize = typeArray.getDimensionPixelOffset(R.styleable.WaveSideBarView_hintTextSize,
														  (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 16,
																						  getResources().getDisplayMetrics()));
		mHintCircleRadius = typeArray.getDimensionPixelOffset(R.styleable.WaveSideBarView_hintCircleRadius,
															  (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 24,
																							  getResources().getDisplayMetrics()));
		mHintCircleColor = typeArray.getColor(R.styleable.WaveSideBarView_hintCircleColor, Color.parseColor("#bef9b81b"));
		mWaveColor = typeArray.getColor(R.styleable.WaveSideBarView_waveColor, Color.parseColor("#bef9b81b"));
		mWaveRadius = typeArray.getDimensionPixelOffset(R.styleable.WaveSideBarView_waveRadius,
														(int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 20,
																						getResources().getDisplayMetrics()));
		mContentPadding = typeArray.getDimensionPixelOffset(R.styleable.WaveSideBarView_contentPadding,
															(int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2,
																							getResources().getDisplayMetrics()));
		mBarPadding = typeArray.getDimensionPixelOffset(R.styleable.WaveSideBarView_barPadding,
														(int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 6,
																						getResources().getDisplayMetrics()));
		mBarWidth = typeArray.getDimensionPixelOffset(R.styleable.WaveSideBarView_barWidth,
